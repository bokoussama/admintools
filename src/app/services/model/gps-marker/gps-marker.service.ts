...
@Injectable()
export class GPSMarkerService {

  resourceQueryUrl: string = '/api/marker';
  resourceCommandUrl: string = '/api/marker';
  resourceSearchUrl: string = '/api/marker/_search';

  constructor(private http: Http) {}

    create(marker: GPSMarker): Observable<GPSMarker> {
    ...
    update(marker: GPSMarker): Observable<GPSMarker> {
        const copy = this.convert(marker);
    ...
    find(id: number): Observable<GPSMarker> {
    ...
    private convert(marker: GPSMarker): GPSMarker {
        const copy: GPSMarker = Object.assign({}, marker);
        return copy;
    }
