...
describe('StationService', () => {
  ...
  describe('#create(station)', () => {
    ...
    it('should create a station Object', inject([StationService], (service: StationService) => {
  ...
  describe('#create(station)', () => {
    it('should update the station in', inject([StationService], (service: StationService) => {
      let station1 = new Station({
        id: 1;
        reference: 'dfckugdsuvge';
        label: 'test station';
  ...
  describe('#update(station)', () => {
    ...
    it('should automatically assign an incrementing id', inject([StationService], (service: StationService) => {
      let station1 = new Station({
        id: 1;
        reference: 'dfckugdsuvge';
        label: 'test station';
  ...
  describe('#delete(id)', () => {
    ...
    it('should remove marker with the corresponding id', inject([StationService], (service: StationService) => {
      let station1 = new Station({
        id: 1;
        reference: 'dfckugdsuvge';
        label: 'test station';
    ...
    it('should not removing anything if marker with corresponding id is not found', inject([StationService], (service: StationService) => {
      let station1 = new Station({
        id: 1;
        reference: 'dfckugdsuvge';
        label: 'test station';
  ...
  describe('#updateMarkerById(id, values)', () => {
    ...
    it('should return marker with the corresponding id and updated data', inject([StationService], (service: StationService) => {
      let station1 = new Station({
        id: 1;
        reference: 'dfckugdsuvge';
        label: 'test station';
    ...
    it('should return null if station is not found', inject([StationService], (service: StationService) => {
      let station1 = new Station({
        id: 1;
        reference: 'dfckugdsuvge';
        label: 'test station';
