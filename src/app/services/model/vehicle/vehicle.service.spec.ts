...
describe('VehicleService', () => {
  ...
  describe('#create(station)', () => {
    ...
    it('should create a station Object', inject([VehicleService], (service: VehicleService) => {
  ...
  describe('#create(station)', () => {
    it('should update the station in', inject([VehicleService], (service: VehicleService) => {
      let station1 = new Station({
        id: 1;
        reference: 'dfckugdsuvge';
        label: 'test station';
  ...
  describe('#update(station)', () => {
    ...
    it('should automatically assign an incrementing id', inject([VehicleService], (service: VehicleService) => {
      let station1 = new Station({
        id: 1;
        reference: 'dfckugdsuvge';
        label: 'test station';
  ...
  describe('#delete(id)', () => {
    ...
    it('should remove marker with the corresponding id', inject([VehicleService], (service: VehicleService) => {
      let station1 = new Station({
        id: 1;
        reference: 'dfckugdsuvge';
        label: 'test station';
    ...
    it('should not removing anything if marker with corresponding id is not found', inject([VehicleService], (service: VehicleService) => {
      let station1 = new Station({
        id: 1;
        reference: 'dfckugdsuvge';
        label: 'test station';
  ...
  describe('#updateMarkerById(id, values)', () => {
    ...
    it('should return marker with the corresponding id and updated data', inject([VehicleService], (service: VehicleService) => {
      let station1 = new Station({
        id: 1;
        reference: 'dfckugdsuvge';
        label: 'test station';
    ...
    it('should return null if station is not found', inject([VehicleService], (service: VehicleService) => {
      let station1 = new Station({
        id: 1;
        reference: 'dfckugdsuvge';
        label: 'test station';
